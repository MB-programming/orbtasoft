...
<main>
  <section class="page-hero">
    ...
    <div class="container">
      ...
      <h1 class="reveal"><?= e(t('tool_download_tiktok_title')) ?></h1>
      <p class="reveal"><?= e(t('tool_download_tiktok_desc')) ?></p>
    </div>
  </section>

  <section class="section section--tight">
    <div class="container">
      <form method="get" action="/tool-download-tiktok.php" class="tool-form reveal no-print">
        <input type="text" name="url" value="<?= e($videoUrl) ?>" placeholder="<?= e(t('downloader_url_placeholder_tiktok')) ?>" aria-label="<?= e(t('downloader_url_label')) ?>" required>
      ...
      <?php elseif ($info): ?>
        <div class="tool-result">
          <?= tools_render_report_header(t('tool_download_tiktok_title'), $videoUrl) ?>
          ...
          <div class="tool-actions-row">
            <a href="/tool-download-tiktok.php" class="tool-check-another no-print"><?= e(t('tools_check_another')) ?></a>
          </div>
        </div>
      <?php endif; ?>
    </div>
