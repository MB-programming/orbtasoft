...
function icon(string $name): string
{
    $icons = [
        ...
        'share-2' => '<circle cx="18" cy="5" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="19" r="3"/><path d="M8.59 13.51 15.42 17.49"/><path d="M15.41 6.51 8.59 10.49"/>',
        'message-circle' => '<path d="M7.9 20A9 9 0 1 0 4 16.1L2 22Z"/>',
        'hash' => '<line x1="4" x2="20" y1="9" y2="9"/><line x1="4" x2="20" y1="15" y2="15"/><line x1="10" x2="8" y1="3" y2="21"/><line x1="16" x2="14" y1="3" y2="21"/>',
        'terminal' => '<path d="m4 17 6-6-6-6"/><path d="M12 19h8"/>',
        'download' => '<path d="M12 15V3"/><path d="M6 10a1 1 0 0 0-.7 1.7l5.7 5.7a1 1 0 0 0 1.4 0l5.7-5.7A1 1 0 0 0 18 10"/><path d="M21 15v6a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1v-6"/>',
    ];
